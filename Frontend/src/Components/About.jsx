...
const About = () => {
  return (
    <section id="about" className="relative w-full h-250 flex items-center justify-center text-white ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center md:text-left">
            ...
            <p className="text-2xl lg:text-3xl xl:text-4xl mb-6 leading-relaxed">
            ...
            <ul className="mt-8 pt-8 grid grid-cols-1 md:grid-cols-3 gap-10 text-center text-2xl lg:text-3xl xl:text-4xl">
